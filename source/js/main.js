...
var button = document.querySelector('.main-menu__button-toggle');
...
function close_menu() {
  ...
  button.classList.remove('main-menu__button-toggle--toggle-modif');
}

function open_menu() {
  menu.classList.toggle('hide');
  button.classList.toggle('main-menu__button-toggle--toggle-modif');
}
